...
public class ConnectorFrameworkFactory {
    ...
    private final List<AutoIDConnectorFacade> facadeList = new ArrayList();
    ...
    public ConnectorFacade newConnectorFacadeInstance(final APIConfiguration config) {
        AutoIDConnectorFacade facade = (AutoIDConnectorFacade) ConnectorFacadeFactory.getInstance().newInstance(config);
